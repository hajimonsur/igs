    ...
    <header className="bg-light py-5" ref={ref}>
      <div className="container d-flex flex-column flex-lg-row align-items-center justify-content-between">
        ...
        <motion.div
          ...
          whileInView={{
            y: [0, -10], // Only two keyframes for y to avoid the error
        ...
        >
          ...
          <p className="lead text-secondary">
            Empowering Students for a Brighter Tomorrow with strong Academic, Moral and Religious Values.
          </p>
          <motion.a
            href="#contact"
        ...
        <motion.div
          ...
          whileInView={{
            y: [0, -10], // Same two keyframes for bounce effect
            transition: { type: 'spring', stiffness: 100, damping: 10 }
          }}
        >
          <img
